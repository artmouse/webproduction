...
class Engine_Request {
    ...
    /**
     * Установить "контент 404" - перключить движок на 404ю страницу, для продукта
     */
    public function setProductContentNotFound() {
        Engine::Get()->getResponse()->setHTTPStatus404();
        $this->setContentID($this->getProductContentIDNotFound());
    }

    /**
     * Установить "контент 404" - перключить движок на 404ю страницу, для категории
     */
    public function setCategoryContentNotFound() {
        Engine::Get()->getResponse()->setHTTPStatus404();
        $this->setContentID($this->getCategoryContentIDNotFound());
    }

    /**
     * Установить "контент 404" - перключить движок на 404ю страницу, для бренда
     */
    public function setBrandContentNotFound() {
        Engine::Get()->getResponse()->setHTTPStatus404();
        $this->setContentID($this->getBrandContentIDNotFound());
    }
    ...
    /**
     * Получить contentID, который установится в случае
     * отсутствия подходящего контента для продукта
     *
     * @return string
     */
    public function getProductContentIDNotFound() {
        return $this->_contentProductID404;
    }

    /**
     * Получить contentID, который установится в случае
     * отсутствия подходящего контента для категории
     *
     * @return string
     */
    public function getCategoryContentIDNotFound() {
        return $this->_contentCategoryID404;
    }

    /**
     * Получить contentID, который установится в случае
     * отсутствия подходящего контента для бренда
     *
     * @return string
     */
    public function getBrandContentIDNotFound() {
        return $this->_contentBrandID404;
    }
    ...
    private $_contentProductID404 = '404-product';

    private $_contentCategoryID404 = '404-category';

    private $_contentBrandID404 = '404-brand';
