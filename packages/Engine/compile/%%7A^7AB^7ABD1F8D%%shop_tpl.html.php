<?php /* Smarty version 2.6.27-optimized, created on 2015-12-02 18:01:32
         compiled from /var/www/shop.local//templates/default//shop_tpl.html */ ?>
<!DOCTYPE html>
<html>
<head>
...
"><?php echo $this->_tpl_vars['email']; ?>
                    ...
                    <div class="footer-menu">
                        ...
                        <?php echo $this->_tpl_vars['integration_facebook_pixel_body']; ?>
...
/registration/"><?php echo $this->_tpl_vars['translate_registration']; ?>
                    ...
                    <div class="footer-line">
                        ...
                        <div class="wps">
                            <a href="http://webproduction.ua/"><?php echo $this->_tpl_vars['translate_creating_online_shops']; ?>
</a>
                            <?php echo $this->_tpl_vars['translate_on_platform']; ?>

                            <a href="http://webproduction.ua/oneclick">OneBox &reg;</a>
                        </div>
...
" width="800" height="350" alt=""/>
                <div class="foot">
                    <a class="os-submit green" href="javascript: void(0);" onclick="popup_welcome_close(<?php echo $this->_tpl_vars['welcomeBannerId']; ?>
);"><?php echo $this->_tpl_vars['translate_to_website']; ?>
</a>
                </div>
            </div>
...
">
    ...
    <div id="block_banner_pageinterval">
        <?php echo $this->_tpl_vars['block_banner_pageinterval']; ?>
