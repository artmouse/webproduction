<?php /* Smarty version 2.6.27-optimized, created on 2015-11-13 16:34:33
         compiled from /var/www/shop.local//templates/default//block/block_banner_right.html */ ?>
<?php if ($this->_tpl_vars['bannerRightArray']): ?>
    <div class="os-columnbanner-carousel">
        <?php if (count ( $this->_tpl_vars['bannerRightArray'] ) > 1): ?>
            <div class="line">
                <ul>
                    <?php $_from = $this->_tpl_vars['bannerRightArray']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
