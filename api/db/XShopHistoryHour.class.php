<?php
/**
 * Class XShopHistoryHour is ORM to table shophistoryhour
 * @author SQLObject
 * @package SQLObject
 */
class XShopHistoryHour extends SQLObject {
    ...
    public function __construct($id = 0) {
        $this->setTablename('shophistoryhour');
        $this->setClassname(__CLASS__);
        parent::__construct($id);
    }

    /**
     * @return XShopHistoryHour
     */
     ...
     * @return XShopHistoryHour
     */
    public static function Get($key) {return self::GetObject("XShopHistoryHour", $key);}

}

SQLObject::SetFieldArray('shophistoryhour', array('id', 'userid', 'cdate', 'url', 'ip', 'post'));
SQLObject::SetPrimaryKey('shophistoryhour', 'id');
