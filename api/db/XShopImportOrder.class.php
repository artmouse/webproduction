<?php
/**
 * Class XShopImportOrder is ORM to table shopimportorder
 * @author SQLObject
 * @package SQLObject
 */
class XShopImportOrder extends SQLObject {
    ...
    public function __construct($id = 0) {
        $this->setTablename('shopimportorder');
        $this->setClassname(__CLASS__);
        parent::__construct($id);
    }

    /**
     * @return XShopImportOrder
     */
     ...
     * @return XShopImportOrder
     */
    public static function Get($key) {return self::GetObject("XShopImportOrder", $key);}

}

SQLObject::SetFieldArray('shopimportorder', array('id', 'cdate', 'pdate', 'userid', 'file', 'comment', 'trycnt'));
SQLObject::SetPrimaryKey('shopimportorder', 'id');
