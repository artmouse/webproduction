...
class Datasource_TextPages extends Forms_ADataSourceSQLObject {
    ...
    protected function _initialize() {
        ...
        $field->setName(Shop::Get()->getTranslateService()->getTranslateSecure('translate_page_content'));
        $this->addField($field);
        ...
        try {
            ...
            try {
                ...
                CommentsAPI::Get()->addComment(
                    ...
                    Shop::Get()->getTranslateService()->getTranslateSecure('translate_added_a_new_page').
                    ' #'.$r.' '.$x->getName(),
                    $user->getId()
                );
            } catch (Exception $e) {
        ...
        try {
            ...
            try {
                ...
                CommentsAPI::Get()->addComment(
                    ...
                    Shop::Get()->getTranslateService()->getTranslateSecure('translate_edited_text_page').
    ...
    public function delete($key) {
        try {
            ...
            try {
                ...
                CommentsAPI::Get()->addComment(
                    'shop-history-textpage-'.$textpage->getId(),
                    Shop::Get()->getTranslateService()->getTranslateSecure('translate_removed_page').
                    ' #'.$textpage->getId().' '.$textpage->getName(),
                    $user->getId()
                );
            } catch (Exception $e) {
