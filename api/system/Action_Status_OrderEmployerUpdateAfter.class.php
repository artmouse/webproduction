...
class Action_Status_OrderEmployerUpdateAfter implements Events_IEventObserver {
    ...
    public function notify(Events_Event $event) {
        ...
        while ($x = $blocks->getNext()) {
            ...
            if (method_exists($block, 'processOrderEmployerUpdateAfter')) {
                try {
                ...
                $block->processOrderEmployerUpdateAfter($event);
            }
