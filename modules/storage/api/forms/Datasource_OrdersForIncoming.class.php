...
/**
 * Заказы для приходования
 *
 * @copyright WebProduction
 * @package   OneBox
 */
class Datasource_OrdersForIncoming extends Forms_ADataSourceSQLObject {
    ...
    protected function _initialize() {
        ...
        $field = new Shop_ContentField_Actions(
            ...
            array(
                array(
                    'actionName' => 'Оприходовать',
                    'contentID' => 'shop-admin-storage-order-toincoming'
                ),
                array(
