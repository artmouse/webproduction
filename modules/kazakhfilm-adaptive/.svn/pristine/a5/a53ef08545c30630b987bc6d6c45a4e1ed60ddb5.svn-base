<?php
class Datasource_Products_Kazah extends Forms_ADataSourceSQLObject {
    ...
    protected function _initialize() {
        ...
        $field->setName(Shop_TranslateFormService::Get()->getTranslateSecure('translate_price').'<br>сутки');
        $field->setQuickedit(true);
        $this->addField($field);

        $field = new Forms_ContentFieldNumeric('price_half');
        $field->setName(Shop_TranslateFormService::Get()->getTranslateSecure('translate_price').'<br>полсуток');
        $field->setQuickedit(true);
        $this->addField($field);
