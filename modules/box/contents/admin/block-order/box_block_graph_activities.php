<?php
class box_block_graph_activities extends Engine_Class {
     ...
     * @return array
     */
    private function _makeIssueCountArray($parentID, $resultArray) {
        ...
        while ($sub = $subIssues->getNext()) {
            if ($sub->getId() != $parentID) {
                ...
                $resultArray = $this->_makeIssueCountArray($sub->getId(), $resultArray);
            }
        }
