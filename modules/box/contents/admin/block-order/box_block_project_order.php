<?php
class box_block_project_order extends Engine_Class {
    ...
    private function _makeIssueArray(ShopOrder $issue) {
        ...
        try {
            $authorName = $issue->getAuthor()->makeName(true, 'lfm');
            $authorUrl = $issue->getAuthor()->makeURLEdit();
        } catch (Exception $ee) {
